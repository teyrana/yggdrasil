...
Eigen::Vector2d Bounds::as_global(const Eigen::Vector2d& p_local) const {
    return p_local + southwest_;
}

Eigen::Vector2d Bounds::as_local(const Eigen::Vector2d& p_global) const {
    return p_global - southwest_;
}
